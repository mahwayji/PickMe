...
export const CreateSectionForm: React.FC<Props> = ({ open, setOpen, data, setData, userId }: Props) => {
        ...
        <Dialog open={open} onOpenChange={setOpen} >
            <DialogContent className="rounded-full [&>button]:hidden">
                ...
                <DialogHeader>
                    ...
                    <DialogTitle className='font-light text-lg text-black-1000'>Create Section</DialogTitle>
                    </div>
